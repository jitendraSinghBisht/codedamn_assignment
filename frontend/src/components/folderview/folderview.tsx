...
function Folder({ folder }: { folder: IFolder }) {
  ...
  async function readFile(fileId: string) {
    const response = await fetch(`http://localhost:8000/api/file/read-file/${fileId}`, {
      method: "GET",
      mode: "no-cors",
      headers: {
  ...
  async function changeFile(fileId: string) {
    const response = await fetch(
      `http://localhost:8000/api/file/update-file/${file.curFileId}`,
      {
        method: "PATCH",
        mode: "no-cors",
        headers: {
  ...
  async function createFile(folderId: string) {
    ...
    const response = await fetch(`http://localhost:8000/api/file/create-file/${folderId}`, {
      method: "POST",
      mode: "no-cors",
      headers: {
        "Content-Type": "application/json",
  ...
  async function createFolder(folderId: string) {
    ...
    const response = await fetch(`http://localhost:8000/api/file/create-folder/${folderId}`, {
      method: "POST",
      mode: "no-cors",
      headers: {
        "Content-Type": "application/json",
  ...
  async function deleteFolder(folderId: string) {
    const response = await fetch(`http://localhost:8000/api/file/delete-folder/${folderId}`, {
      method: "DELETE",
      mode: "no-cors",
      headers: {
        "Content-Type": "application/json",
  ...
  async function deleteFile(fileId: string) {
    const response = await fetch(`http://localhost:8000/api/file/delete-file/${fileId}`, {
      method: "DELETE",
      mode: "no-cors",
      headers: {
        "Content-Type": "application/json",
...
function Folderview() {
  ...
  async function saveFile() {
    const response = await fetch(
      `http://localhost:8000/api/file/${file.curFileId}`,
      {
        method: "PATCH",
        mode: "no-cors",
        headers: {
